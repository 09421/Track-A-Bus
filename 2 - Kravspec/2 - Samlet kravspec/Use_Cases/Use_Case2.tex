\subsection{Use Case 2: Vis placering af alle busser og stoppesteder på valgt rute}
\textbf{Mål:}
\\
...
\begin{enumerate}[A.]
	\item Opdatering af busposition forekommer hvert sekund, med en max. afvigelse på +0.5 sekunder
\end{enumerate}
...
\item Systemet indtegner busserne på deres position.
\item Systemet vil efter et tidsinterval, hente bussernes position igen.
\item Systemet opdatere bussernes position på kortet.
