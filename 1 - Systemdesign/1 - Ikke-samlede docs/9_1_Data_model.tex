...
Den distribuerede database gemmer alt information vedrørende busserne og deres ruter. Opbygningen af databasen kan ses som fire komponenter der interagerer; Busser, Busruter, Stoppesteder og positions data.\\ På figur \ref{fig:MySQLUML} vises der et UML OO diagram over MySQL databasen.
...
\end{figure}
\noindent
De fire database komponenter beskrives herunder.\\\\

\textbf{Bus}\\
Komponenten Bus består af sin egen tabel, og kan ses som den databasemæssige reprensation af en vilkårlig bus. Den har således et ID som primary key, som er det ID man ville kunne ses på bussen.
