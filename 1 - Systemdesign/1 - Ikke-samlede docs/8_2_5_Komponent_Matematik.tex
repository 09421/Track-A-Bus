...
d &= R * c * 1000 
\end{align}
atan2 returner et grad værdi mellem -180\textdegree til 180\textdegree. Det er dog ikke nødvendigt at tage højde for dette i denne sammenhæng, da graderne ikke skal konvertes til helcirkel fra 0\textdegree til 360\textdegree.\\
Hjemmesiden, simulatoren og MySQL databasen tager alle brug af Haversine formlen. 
\begin{itemize}
	\item På hjemmesiden bruges formlen når det skal udregnes, hvilke to rutepunkter et stoppested skal ligge mellem. I denne situation skal det undersøges om stoppestedet ligger en vis afstand væk fra et punkt. Her til bruges Haversine til at udregne distancen.
	\item I simulatoren bruges formlen når bussens næste position skal udregnes. I denne situation skal afstanden mellem to rutepunkter udregnes.
...
Hvis et objekt skal placeres mellem to punkter, en vis distance udfra det første punkt, med en vis kurs mod det andet punkt, tages denne formel i brug. Kursen mellem de to punkter er givet på en 360\textdegree skala, hvor nord er sat til 0\textdegree/360\textdegree. Igennem udregnningen er det blevet gjort brug af følgende variabler og konstanter:\\
\begin{tabular}{ l p{10cm} }
\textbf{R}: & Jordens gennemsnits radius. Konstant sat til 6371 kilometer.\\
...
\\Ved udregninger af breddegraden af objektet bruges atan2, og da der skal returneres et antal grader, skal denne værdi konvertes til en 360\textdegree skala. Dette gøres ved hjælp af formel (7)\\
...
\begin{tabular}{ l p{10cm} }
\textbf{A}: & hældningskoefficient for Linjestykket mellem P1 og P2 .\\
\textbf{B}: & Skæring med y-aksen for injestykket mellem P1 og P2 \\
...
\end{align}\\\\
I tilfælde af at linjen mellem punkt 1 og punkt 2 er horisontal eller vertikal, er der under implementering skabt special tilfælde. Hvis linjen er horisontal sættes $\theta_4 = \theta_1$ og $\lambda_4 = \lambda_3$. Hvis linjen er vertikal sættes $\theta_4 = \theta_3$ og $\lambda_4 = \lambda_1$. Situation ses på figur \ref{taettestPunkt_special}
\begin{figure}[h!]
\centering
...
\end{itemize}
\noindent
Hvis blot en af disse regler passer, er punktet ugyldigt, da det ikke ligger på linjestykket. Under udregningen af stoppestedernes position på ruten, er der dog tilføjet en ekstra undersøgelse. Hvis distancen mellem stoppestedet er mindre en 25 meter, gyldigøres udregninger selvom en eller flere af de overstående punkter er gældende. Dette gøres, da et stoppested kan ligge tilpas forskudt fra ruten til, at den ikke vil passe på noget linjestykke. 

\noindent
Denne formel er lavet på baggrund af information fundet på to hjemmesider.\\ \url{http://demo.activemath.org/ActiveMath2/search/show.cmd?id=mbase://AC_UK_calculus/functions/ex_linear_equation_two_points} beskriver hvordan den lineære funktion findes givet ved to punkter. \\\url{http://math.ucsd.edu/~wgarner/math4c/derivations/distance/distptline.htm} beskriver hvordan det ortogonale punkt findes ved hjælp af en lineær funktion.\\
