...
\begin{lstlisting}[caption=GetClosestBusDescProc foreskel 1, label={lst:GetClosestBusDescProc_Diff1},language=SQL]
...
...
\begin{lstlisting}[caption=GetClosestBusDescProc foreskel 2, label={lst:GetClosestBusDescProc_Diff2},language=SQL]
...
if(closestEndPoint >= currentStopId) then
...
\end{lstlisting}
...
I \textit{GetClosestEndpointDesc} er der nogle enkelte foreskelle, som her vil beskrives. På kodeudsnit \ref{lst:GetClosestEndpointDesc_diff1}, kan det ses hvordan ruten nu hentes ud i en tabel, hvor der sorteres efter IDet i \textit{BusRoute\_RoutePoint} tabellen, i faldende rækkefølge.
\begin{lstlisting}[caption=GetClosestEndpointDesc foreskel 1, label={lst:GetClosestEndpointDesc_diff1},language=SQL]
...
...
\begin{lstlisting}[caption=GetClosestEndpointDesc foreskel 2, label={lst:GetClosestEndpointDesc_diff2},language=SQL]
...
